...
<div class="card card-custom">
     ...
     <!--begin::Form-->
     <form name="frmProduct" id="frmProduct" method="post" action="{{route('news.images.store',$news->id)}}" enctype="multipart/form-data">
          @csrf
          <div class="card-body">
               ...
               <div class="form-group">
                    <label>Select News Image<span class="text-danger">*</span></label>
               ...
               <div class="card-footer">
                    ...
                    <a class="btn btn-light-primary" href="{{route('news.images.index',$news->id)}}">Back</a>
