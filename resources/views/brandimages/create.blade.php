...
<div class="card card-custom">
     ...
     <!--begin::Form-->
     <form name="frmProduct" id="frmProduct" method="post" action="{{route('brands.images.store',$brand->id)}}" enctype="multipart/form-data">
          @csrf
          <div class="card-body">
               ...
               <div class="card-footer">
                    ...
                    <button type="Button" class="btn btn-light-primary" onclick='window.location.href="{{route('brands.images.index',$brand->id)}}"'>Back</button>
               </div>
          </div>
     </form>
     <!--end::Form-->
