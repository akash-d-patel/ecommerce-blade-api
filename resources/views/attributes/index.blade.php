...
<div class="card card-custom">
    ...
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
        ...
        <div class="card-toolbar">
            ...
            <!--begin::Button-->
            <a href="{{ route('attributes.create')}}" class="btn btn-light-primary px-6 font-weight-bold">Create Attribute</a>
            <!--end::Button-->
        </div>
    </div>
    ...
    <div class="card-body">
        ...
        <!--begin::Search Form-->
        <form name="frmSearch" id="frmSearch" method="get" action="{{route('attributes.index')}}">
                    ...
                    <div class="col-lg-12 col-xl-8">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-4 col-xl-4 mt-5 mt-lg-0">
                                ...
                                <button type="reset" onclick="window.location.href='{{route('attributes.index')}}'" class="btn btn-light-primary">
                                    Clear
                                </button>
        ...
        <table class="table table-bordered table-hover" id="kt_datatable">
            <thead>
                <tr>
                    ...
                    <th>
                        ...
                        <a href="{{route('attributes.index')}}?sort[]=name,desc">Name</a>
                        @else
                        <a href="{{route('attributes.index')}}?sort[]=name,asc">Name</a>
                        @endif
                    </th>
                    <th>Order</th>
                    <th>Status</th>
                    <th>
                        ...
                        <a href="{{route('attributes.index')}}?sort[]=created_at,desc">Created</a>
                        @else
                        <a href="{{route('attributes.index')}}?sort[]=created_at,asc">Created</a>
                        @endif
                    </th>
                    <th>Created By</th>
                    <th>Actions</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td nowrap>
                        <form method="POST" action="{{ route('attributes.destroy', $attribute->id) }}" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">
                            <a href="{{route('attributes.edit',$attribute->id)}}" class="btn btn-icon btn-light btn-sm mx-3"> {{ Metronic::getSVG("media/svg/icons/Communication/Write.svg", "svg-icon-md svg-icon-primary") }}</a>
                            @method('DELETE')
                            @csrf
                            ...
                            <a href="{{route('attribute-value.index',$attribute->id)}}" class="ki ki-plus mx-5" title="Add AttributeValues"> </a>
                        </form>
                    </td>
                </tr>
                @empty
