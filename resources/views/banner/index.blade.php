...
<div class="card card-custom">
    ...
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
        ...
        <div class="card-toolbar    ">
            ...
            <!--begin::Button-->
            <a href="{{ route('banners.create')}}" class="btn btn-light-primary px-6 font-weight-bold">Create Banner</a>
            <!--end::Button-->
        </div>
    </div>
    ...
    <div class="card-body">
        ...
        <!--begin::Search Form-->
        <form name="frmSearch" id="frmSearch" method="get" action="{{route('banners.index')}}">
                    ...
                    <div class="col-lg-12 col-xl-8">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-4 col-xl-4 mt-5 mt-lg-0">
                                ...
                                <button type="reset" onclick="window.location.href='{{route('banners.index')}}'" class="btn btn-light-primary">Clear</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <thead>
                <tr>
                    ...
                    <th>
                        ...
                        <a href="{{route('banners.index')}}?sort[]=name,desc">Name</a>
                        @else
                        <a href="{{route('banners.index')}}?sort[]=name,asc">Name</a>
                        @endif
                    </th>
                    <th>Description</th>
                    <th>Status</th>
                ...
                <tr>
                    ...
                    <td nowrap>
                        ...
                        <form method="POST" action="{{ route('banners.destroy', $banner->id) }}">
                            @method('DELETE')
                            @csrf
                            <a href="{{route('banners.edit', $banner->id)}}" class="btn btn-icon btn-light btn-sm mx-3">
                            ...
                            <a href="{{route('banners.images.index',$banner->id)}}" class="ki ki-plus mx-5" title="Add Banner Image"> </a>
                        </form>
                    </td>
                </tr>
                @empty
