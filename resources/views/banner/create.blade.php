...
<div class="card card-custom">
  ...
  <!--begin::Form-->
  <form name="frmBanner" id="frmBanner" method="post" action="{{route('banners.store')}}">
    @csrf
    <div class="card-body">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Enter banner name" />
        @error('name')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
      </div>
      ...
      <div class="form-group mb-1">
        ...
        <textarea class="form-control @error('description') is-invalid @enderror"" id=" description" name="description" rows="3" placeholder="Enter banner description"></textarea>
        @error('description')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
      </div>
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control @error('constant') is-invalid @enderror" name="constant" placeholder="Enter banner constant" />
        @error('constant')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
      </div>
