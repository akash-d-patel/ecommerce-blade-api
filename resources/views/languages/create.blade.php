...
<div class="card card-custom">
    ...
    <!--begin::Form-->
    <form name="frmLanguage" id="frmLanguage" method="post" action="{{ route('languages.store')}}">
        @csrf
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('initial') is-invalid @enderror" name="initial" placeholder="Enter initial" />
                @error('initial')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('class') is-invalid @enderror" name="class" placeholder="Enter class" />
                @error('class')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
