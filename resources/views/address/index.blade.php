...
<div class="card card-custom">
    ...
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
        ...
        <div class="card-toolbar    ">
            ...
            <!--end::Dropdown-->
            <!--begin::Button-->
            <a href="{{ route('addresses.create')}}" class="btn btn-light-primary px-6 font-weight-bold">Create Address</a>
            <!--end::Button-->
        </div>
    ...
    <div class="card-body">
        <!--begin::Search Form-->
        <form name="frmSearch" id="frmSearch" method="get" action="{{route('addresses.index')}}">
                    ...
                    <div class="col-lg-12 col-xl-8">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-4 col-xl-4 mt-5 mt-lg-0">
                                ...
                                <button type="reset" onclick="window.location.href='{{route('addresses.index')}}'" class="btn btn-light-primary">Clear</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <thead>
                <tr>
                    ...
                    <th>
                        ...
                        <a href="{{route('addresses.index')}}?sort[]=name,desc">Name</a>
                        @else
                        <a href="{{route('addresses.index')}}?sort[]=name,asc">Name</a>
                        @endif
                    </th>
                    <th>Mobile No</th>
                    <th>Address Line1</th>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ route('addresses.destroy',$address->id) }}" method="POST">
                            <a href="{{route('addresses.edit',$address->id)}}" class="btn btn-icon btn-light btn-sm mx-3"> {{ Metronic::getSVG("media/svg/icons/Communication/Write.svg", "svg-icon-md svg-icon-primary") }}</a>
                            @csrf
                            @method('DELETE')
