...
<div class="card card-custom">
  ...
  <!--begin::Form-->
  <form name="frmAddress" id="frmAddress" method="post" action="{{route('addresses.store')}}">
    @csrf
    <div class="card-body">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control @error('mobile_no') is-invalid @enderror" name="mobile_no" placeholder="Enter your mobile no" />
        @error('mobile_no')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
      </div>
      ...
      <div class="form-group mb-1">
        ...
        <textarea class="form-control @error('address_line1') is-invalid @enderror"" id=" address_line1" name="address_line1" rows="3" placeholder="Enter your address_line1"></textarea>
        @error('address_line1')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
      </div>
      <div class="form-group mb-1">
        ...
        <textarea class="form-control" id="address_line2" name="address_line2" rows="3" placeholder="Enter your address_line2"></textarea>
      </div>

      <div class="form-group">
        <label>Landmark<span class="text-danger">*</span></label>
        <input type="text" class="form-control @error('landmark') is-invalid @enderror" name="landmark" placeholder="Enter your landmark" />
        @error('landmark')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
      </div>
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control @error('pin_code') is-invalid @enderror" name="pin_code" placeholder="Enter your pin code" />
        @error('pin_code')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
      </div>
      ...
      <div class="form-group">
        <label for="address_type">Address_Type<span class="text-danger"></span></label>
    ...
    <div class="card-footer">
      ...
      <button type="Button" class="btn btn-light-primary" onclick='window.location.href="{{route('addresses.index')}}"'>Back</button>
