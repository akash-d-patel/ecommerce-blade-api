...
<div class="card card-custom">
  ...
  <!--begin::Form-->
  <form name="frmCategory" id="frmCategory" method="post" action="{{route('categories.store')}}">
    @csrf
    <div class="card-body">
      ...
      <div class="form-group mb-1">
        ...
        <textarea class="form-control @error('description') is-invalid @enderror"" id=" description" name="description" rows="3" placeholder="Enter category description"></textarea>
        @error('description')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
      </div>
