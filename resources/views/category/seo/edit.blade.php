...
<div class="card card-custom">
    ...
    <!--begin::Form-->
    <form name="frmSeo" id="frmSeo" method="post" action="{{route('categories.seo.update',[$category->id, $seo->id])}}">
        ...
        <div class="card-footer">
            ...
            <button type="button" onclick='window.location.href="{{route('categories.index',$category->id)}}"' class="btn btn-light-primary">Back</button>
        </div>
    </form>
    <!--end::Form-->
</div>
