...
<div class="card card-custom">
  ...
  <!--begin::Form-->
  <form name="frmCity" id="frmCity" method="post" action="{{route('cities.store')}}">
    @csrf
    <div class="card-body">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Enter city name" />
        @error('name')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
      </div>
    ...
    <div class="card-footer">
      ...
      <button type="Button" class="btn btn-light-primary" onclick='window.location.href="{{route('cities.index')}}"'>Back</button>
