...
<div class="card card-custom">
    ...
    <!--begin::Form-->
    <form name="frmSeo" id="frmSeo" method="post" action="{{route('brands.seo.update',[$brand->id, $seo->id])}}">
        ...
        <div class="card-footer">
            ...
            <button type="button" onclick='window.location.href="{{route('brands.index',$brand->id)}}"' class="btn btn-light-primary">Back</button>
        </div>
    </form>
    <!--end::Form-->
</div>
