...
<div class="card card-custom">
    ...
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
        ...
        <div class="card-toolbar">
            ...
            <div class="dropdown dropdown-inline mr-1">
                ...
                <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                    ...
                    <ul class="navi flex-column navi-hover py-2">
                        ...
                        <li class="navi-item">
                            <a href="{{route('importcsv.brands')}}" class="navi-link">
                                <span class="navi-icon">
            ...
            <!-- end::Dropdown -->
            <!-- begin::Button -->
            <a href="{{ route('brands.create')}}" class="btn btn-light-primary px-6 font-weight-bold">Create Brand</a>
            <!--end::Button-->
        </div>
    ...
    <div class="card-body">
        ...
        <!--begin::Search Form-->
        <form name="frmSearch" id="frmSearch" method="get" action="{{route('brands.index')}}">
                    ...
                    <div class="col-lg-12 col-xl-8">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-4 col-xl-4 mt-5 mt-lg-0">
                                ...
                                <button type="reset" onclick="window.location.href='{{route('brands.index')}}'" class="btn btn-light-primary">Clear</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <thead>
                <tr>
                    ...
                    <th>
                        ...
                        <a href="{{route('brands.index')}}?sort[]=name,desc">Name</a>
                        @else
                        <a href="{{route('brands.index')}}?sort[]=name,asc">Name</a>
                        @endif
                    </th>
                    <th>Order</th>
                    <th>Status</th>
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('brands.destroy',$brand->id) }}" method="POST">
                            <a href="{{route('brands.edit',$brand->id)}}" class="btn btn-icon btn-light btn-sm mx-3"> {{ Metronic::getSVG("media/svg/icons/Communication/Write.svg", "svg-icon-md svg-icon-primary") }}</a>
                            @csrf
                            @method('DELETE')
                            ...
                            <a href="{{route('files.index',$brand->id)}}" class="ki ki-plus mx-5" title="Add Files"> </a>
                            <a href="{{route('brands.images.index',$brand->id)}}" class="ki ki-plus mx-5" title="Add Brand Image"> </a>
                            @if($brand->seo)
                            <a href="{{route('brands.seo.edit',[$brand->id, $brand->seo->id])}}" class="ki ki-plus mx-5" title="Edit Seo"> </a>
                            @else
                            <a href="{{route('brands.seo.create',[$brand->id])}}" class="ki ki-plus mx-5" title="Add Seo"> </a>
                            @endif
                        </form>
                    </td>
                </tr>
