...
<div class="card card-custom">
  ...
  <!--begin::Form-->
  <form name="frmBrand" id="frmBrand" method="post" action="{{ route('brands.store')}}">
    @csrf
    <div class="card-body">
      ...
      <div class="form-group mb-1">
        ...
        <textarea class="form-control @error('description') is-invalid @enderror"" id=" description" name="description" rows="3" placeholder="Enter brand description"></textarea>
        @error('description')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
      </div>
