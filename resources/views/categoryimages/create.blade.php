...
<div class="card card-custom">
     ...
     <!--begin::Form-->
     <form name="frmProduct" id="frmProduct" method="post" action="{{route('categories.images.store',$category->id)}}" enctype="multipart/form-data">
          @csrf
          <div class="card-body">
               ...
               <div class="form-group">
                    <label>Select Category Image<span class="text-danger">*</span></label>
               ...
               <div class="card-footer">
                    ...
                    <button type="Button" class="btn btn-light-primary" onclick='window.location.href="{{route('categories.images.index',$category->id)}}"'>Back</button>
               </div>
          </div>
     </form>
     <!--end::Form-->
