...
<div class="card card-custom">
    ...
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
        ...
        <div class="card-toolbar    ">
            ...
            <!--end::Dropdown-->
            <a href="{{route('reviews.create',$product->id)}}" class="btn btn-light-primary px-6 font-weight-bold">Create Review</a>
                    ...
                    <div class="col-lg-12 col-xl-8">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-4 col-xl-4 mt-5 mt-lg-0">
                                ...
                                <button type="reset" onclick="window.location.href='{{ route('reviews.index',$product->id)}}'" class="btn btn-light-primary ">Clear</button>
            ...
            <thead>
                <tr>
                    ...
                    <th>
                        ...
                        <a href="{{ route('reviews.index',$product->id)}}?sort[]=content,desc">Content</a>
                        @else
                        <a href="{{ route('reviews.index',$product->id)}}?sort[]=content,asc">Content</a>
                        @endif
                    </th>
                    <th>
                        @if(!empty(request()->sort) && in_array('rate,asc', request()->sort))
                        <a href="{{ route('reviews.index',$product->id)}}?sort[]=rate,desc">Rate</a>
                        @else
                        <a href="{{ route('reviews.index',$product->id)}}?sort[]=rate,asc">Rate</a>
                        @endif
                    </th>
                    <th>Status</th>
                    <th>Created</th>
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('reviews.destroy',[$product->id,$review->id])}}" method="POST">
                            <a href="{{route('reviews.edit',[$product->id,$review->id])}}" class="btn btn-icon btn-light btn-sm mx-3"> {{ Metronic::getSVG("media/svg/icons/Communication/Write.svg", "svg-icon-md svg-icon-primary") }}</a>
                            @csrf
                            @method('DELETE')
