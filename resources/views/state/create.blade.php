...
<div class="card card-custom">
  ...
  <!--begin::Form-->
  <form name="frmState" id="frmState" method="post" action="{{route('states.store')}}">
    @csrf
    <div class="card-body">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Enter state name" />
        @error('name')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
      </div>
    ...
    <div class="card-footer">
      ...
      <button type="Button" class="btn btn-light-primary" onclick='window.location.href="{{route('states.index')}}"'>Back</button>
