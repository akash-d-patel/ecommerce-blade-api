...
<div class="card card-custom">
    ...
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
        ...
        <div class="card-toolbar    ">
            ...
            <!--end::Dropdown-->
            <!--begin::Button-->
            <a href="{{ route('menus.create')}}" class="btn btn-light-primary px-6 font-weight-bold">Create Menu</a>
            <!--end::Button-->
        </div>
    ...
    <div class="card-body">
        <!--begin::Search Form-->
        <form name="frmSearch" id="frmSearch" method="get" action="{{route('menus.index')}}">
                    ...
                    <div class="col-lg-12 col-xl-8">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-4 col-xl-4 mt-5 mt-lg-0">
                                ...
                                <button type="reset" onclick='window.location.href="{{route('menus.index')}}"' class="btn btn-light-primary px-6 font-weight-bold">Clear</button>
                            </div>
                        </div>
                    </div>
            ...
            <thead>
                <tr>
                    ...
                    <th>
                        ...
                        <a href="{{route('menus.index')}}?sort[]=name,desc">Name</a>
                        @else
                        <a href="{{route('menus.index')}}?sort[]=name,asc">Name</a>
                        @endif
                    </th>
                    <th>Description</th>
                    <th>status</th>
                    <th>
                        ...
                        <a href="{{route('menus.index')}}?sort[]=created_at,desc">Created At</a>
                        @else
                        <a href="{{route('menus.index')}}?sort[]=created_at,asc">Created At</a>
                        @endif
                    </th>
                    <th>Created By</th>
                    <th>Actions</th>
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('menus.destroy',$menu->id) }}" method="POST">
                            <a href="{{route('menus.edit',$menu->id)}}" class="btn btn-icon btn-light btn-sm mx-3"> {{ Metronic::getSVG("media/svg/icons/Communication/Write.svg", "svg-icon-md svg-icon-primary") }}</a>
                            @csrf
                            @method('DELETE')
