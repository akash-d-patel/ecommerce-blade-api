...
<div class="card card-custom">
    ...
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
        ...
        <div class="card-toolbar    ">
            ...
            <!--begin::Button-->
            <a href="{{ route('testimonials.create')}}" class="btn btn-light-primary px-6 font-weight-bold">Create Testimonial</a>
            <!--end::Button-->
        </div>
    </div>
    ...
    <div class="card-body">
        ...
        <!--begin::Search Form-->
        <form name="frmSearch" id="frmSearch" method="get" action="{{route('testimonials.index')}}">
                    ...
                    <div class="col-lg-12 col-xl-8">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-4 col-xl-4 mt-5 mt-lg-0">
                                ...
                                <button type="reset" onclick="window.location.href='{{route('testimonials.index')}}'" class="btn btn-light-primary">
                                    Clear
                                </button>
        ...
        <table class="table table-bordered table-hover" id="kt_datatable">
            <thead>
                <tr>
                    ...
                    <th>
                        ...
                        <a href="{{route('testimonials.index')}}?sort[]=title,desc">Title</a>
                        @else
                        <a href="{{route('testimonials.index')}}?sort[]=title,asc">Title</a>
                        @endif
                    </th>
                    <th>Status</th>
                    <th>Order</th>
                    <th>
                        ...
                        <a href="{{route('testimonials.index')}}?sort[]=created_at,desc">Created</a>
                        @else
                        <a href="{{route('testimonials.index')}}?sort[]=created_at,asc">Created</a>
                        @endif
                    </th>
                    <th>Created By</th>
                    <th>Actions</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td nowrap>
                        <form method="POST" action="{{ route('testimonials.destroy', $testimonial->id) }}" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">
                            <a href="{{route('testimonials.edit',$testimonial->id)}}" class="btn btn-icon btn-light btn-sm mx-3"> {{ Metronic::getSVG("media/svg/icons/Communication/Write.svg", "svg-icon-md svg-icon-primary") }}</a>
                            @method('DELETE')
                            @csrf
